...
from fuc.algorithm.feature.Image2Image.Quick_Sketch.main import U2Net_Portrait

logger = logging.getLogger(__name__)


class Quick_Sketch_View(APIView):
    """
    示例API
    """
    ...
    def post(self, request: Request):
        ...
        result: str = U2Net_Portrait(content_imagePath)
