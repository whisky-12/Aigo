...
Generated by 'django-fuc startproject' using Django 3.2.3.
...
MIDDLEWARE = [
    ...
    "common.utils.middleware.ApiSecurityMiddleware",
]
...
AUTH_USER_MODEL = "algorithm.Users"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "common.utils.pagination.CustomPagination",  # 自定义分页
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "rest_framework.authentication.SessionAuthentication",  # 基于Session认证方式
        # "rest_framework.authentication.BasicAuthentication",  # 基于用户名密码认证方式
    ),
    ...
    "EXCEPTION_HANDLER": "common.utils.exception.CustomExceptionHandler",  # 自定义的异常处理
}
# ================================================= #
# ******************** 登录方式配置 ******************** #
# ================================================= #
...
AUTHENTICATION_BACKENDS = [
    # "common.utils.backends.CustomBackend"
]
...
# ********** 一键导入插件配置开始 **********
# 例如:
# from admin_upgrade_center.settings import *    # 升级中心
# from admin_celery.settings import *            # celery 异步任务
# ...
# ********** 一键导入插件配置结束 **********
